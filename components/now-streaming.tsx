      ...
      <div className="container w-full max-w-full px-4 md:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
          <div className="space-y-2">
            <div className="inline-block rounded-lg bg-white px-3 py-1 text-sm border-2 border-black">
              NOW STREAMING
            </div>
        ...
        <div className="mx-auto max-w-7xl border-8 border-black bg-white p-6 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] -rotate-1">
          <div className="absolute -top-5 -right-5 bg-pink-500 px-4 py-2 text-white text-lg font-bold border-4 border-black rotate-6">
            WEDNESDAY 6PM
          </div>
